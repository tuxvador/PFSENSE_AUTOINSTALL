...
sleep $timerkey
qm sendkey $1 v-t-n-e-t-0-kp_enter

#select lan interface
sleep $timerkey
qm sendkey $1 v-t-n-e-t-1-kp_enter

#select optional interface
sleep $timerkey
qm sendkey $1 v-t-n-e-t-2-kp_enter-y-kp_enter
...
qm sendkey $1 1-0-dot-0-dot-0-dot-1-kp_enter
...
qm sendkey $1 1-9-2-dot-1-6-8-dot-2-dot-2-kp_enter
#Enter LAN network mask
qm sendkey $1 2-4-kp_enter
#Enter LAN gateway
qm sendkey $1 1-0-dot-0-dot-0-dot-2-kp_enter
qm sendkey $1 1-0-dot-0-dot-0-dot-2-kp_enter
qm sendkey $1 y-kp_enter
...
qm sendkey $1 1-9-2-dot-1-6-8-dot-2-0-dot-1-0-0-kp_enter
qm sendkey $1 1-9-2-dot-1-6-8-dot-2-0-dot-2-0-0-kp_enter
qm sendkey $1 kp_enter
